var margin = { top: 50, right: 0, bottom: 20, left: 65 },
    ...
    var tip = d3.tip()
        ...
        .offset([-10, 0])
        .html(function(d) {
            return "<strong> PurchasingPower: </strong> <span style='color:red'>" + d.PurchasingPower + "</span>";
        })
    ...
    d3.json("../../json/PurchasingPower.json", function(error, data) {
        ...
        y.domain([0, d3.max(data, function(d) { return d.PurchasingPower > 16500 ? d.PurchasingPower : 16500; })]);
